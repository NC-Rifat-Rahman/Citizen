            ...
            <main id="main" class="site-main">
                <div class="cont maincont">
                    ...
                    <article>
                        ...
                        <?php
                        $res = mysqli_query($conn, "SELECT * FROM `products` WHERE `catagory` LIKE 'face mask' AND `product_code` != 2")
                        ?>
                                        ...
                                        <div class="sectgl prod-i">
                                            ...
                                            <div class="prod-i-bot">
                                                <div class="prod-i-info">
                                                    ...
                                                    <p class="prod-i-categ"><a href="All_Products_mask.php">Facemask</a>
                                                    </p>
                                                </div>
