...
<head>
    ...
    <title>Protective face mask</title>
                    ...
                    <article>
                        ...
                        <div class="prod">
                            ...
                            <div class="prod-cont">
                                ...
                                <p class="prod-categs"><a href="All_Products_mask.php">Face mask</a>, <a href="#"><?php echo $row["brand"]; ?></a></p>
                        ...
                        <?php
                        $res = mysqli_query($conn, "SELECT * FROM `products` WHERE `catagory` LIKE 'face mask' AND `product_code` != 1")
                        ?>
                                        ...
                                        <div class="sectgl prod-i">
                                            ...
                                            <div class="prod-i-bot">
                                                <div class="prod-i-info">
                                                    ...
                                                    <p class="prod-i-categ"><a href="All_Products_mask.php">Face mask</a>
                                                    </p>
                                                </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-3 col-md-2 align-center-mobile widget">
                    ...
                    <ul class="menu">
                        ...
                        <a href="All_Products_mask.php">face mask</a>

                        </li>

                        <li>

                        <a href="All_Products_sanitizer.php">hand sanitizer</a>

                        </li>

                        <li>

                        <a href="All_Products_oximeter.php">pulse oximeter</a>
