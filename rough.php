                                        ...
                                        <div class="sectgl prod-i">
                                            ...
                                            <div class="prod-i-bot">
                                                <div class="prod-i-info">
                                                    ...
                                                    <p class="prod-i-categ"><a href=""><?php echo $row["catagory"]; ?></a></p>
                                                </div>
                                                <h3 class="prod-i-ttl"><a href=""><?php echo $row["name"] ?></a></h3>
                                            </div>
                                        </div>
                                    </article>
...
<div class="form-validate modal-form" id="modal-form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form action="catalog-gallery.php" id="checkout" method="get">
                                <button type="button" onclick="form_submit()" class="butn4 btn-primary">continue shopping</button>
                            </form>
                        </div>
                    </div>
                </div>
