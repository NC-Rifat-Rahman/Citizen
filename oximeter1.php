...
<head>
    ...
    <title>jumper pulse oximeter</title>
                    ...
                    <article>
                        ...
                        <div class="prod">
                            ...
                            <div class="prod-cont">
                                ...
                                <p class="prod-categs"><a href="All_Products_oximeter.php">pulse oximeter</a>, <a href="#"><?php echo $row["brand"]; ?></a></p>
                        ...
                        <?php
                        $res = mysqli_query($conn, "SELECT * FROM `products` WHERE `catagory` = 'pulse oximeter' AND `product_code` != 5")
                        ?>
                                        ...
                                        <div class="sectgl prod-i">
                                            ...
                                            <div class="prod-i-bot">
                                                <div class="prod-i-info">
                                                    ...
                                                    <p class="prod-i-categ"><a href="All_Products_oximeter.php">Pulse oximeter</a>
                                                    </p>
                                                </div>
